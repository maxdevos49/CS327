...
void npc_next_pos_rand_tunnel(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
  ...
  } while (d->map[c->pos.y + *y_offset][c->pos.x + *x_offset] == c_h_wall && d->map[c->pos.y + *y_offset][c->pos.x + *x_offset] == c_v_wall);

  return;
}

void npc_next_pos_rand(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
void npc_next_pos_line_of_sight(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
  pos_t dir;
...
void npc_next_pos_line_of_sight_tunnel(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
  pos_t dir;
  dir.y = d->player.y - c->pos.y;
  dir.x = d->player.x - c->pos.x;
...
void npc_next_pos_gradient(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_00(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_01(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_02(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_03(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
  /*     smart;     telepathic; not tunneling; not erratic */
  npc_next_pos_gradient(d, c, x_offset, y_offset);
}

static void npc_next_pos_04(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_05(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_06(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
...
static void npc_next_pos_07(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
  /*     smart;     telepathic;     tunneling; not erratic */
  npc_next_pos_gradient(d, c, x_offset, y_offset);
}

static void npc_next_pos_erratic(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset);

void (*npc_move_func[])(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset) = {
    npc_next_pos_00,
    npc_next_pos_01,
    npc_next_pos_02,
    npc_next_pos_03,
...
void npc_next_pos(dungeon_t *d, character_t *c, int8_t *x_offset, int8_t *y_offset)
{
